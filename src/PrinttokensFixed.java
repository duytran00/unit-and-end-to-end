...
public class PrinttokensFixed{
	...
	{ 
	  ...
	  StringBuilder sb = new StringBuilder();
	   ...
	   if(id==2)                  /* if end character is " and is string */
		   ////////////////////////////////// FAULT CORRECTION. replace id == 1 to id == 2.
	     {
		   if (ch == '"') {
			   sb.append(ch);
		   }
	...
	static boolean is_token_end(int str_com_id, int res)
	{
	 ...
	 if(str_com_id==2)          /* is string token */
		 /////////////////////////// FAULT CORRECTION. replace id ==1 to id == 2
	    { if(ch=='"')   /* for string until meet another " */ 
	    	//////////////////////// FAULT CORRECTION. delete "|| ch=='\n' || ch == '\r' || ch=='\t'"
	         return true;
	      else
	         return false;
	    }
	 ...
	 if(str_com_id==1)    /* is comment token */
		 /////////////////////////// FAULT CORRECTION. replace id ==2 to id == 1
	   { if(ch=='\n' || ch == '\r')     /* for comment until meet end of line */
		   ////////////////////////FAULT CORRECTION. delete "|| ch=='\t'"
	        return true;
	      else
	        return false;
	...
	static boolean is_char_constant(String str)
	{
	  if (str.length() == 2 && str.charAt(0)=='#' && Character.isLetter(str.charAt(1))) 
		  /////////////////// FAULT CORRECTION: replace length > 2 to length = 2. replace || with &&
	     return true;
	  else  
	     return false;
	}
	...
	static boolean is_num_constant(String str)
	{
	  ...
	  if ( Character.isDigit(str.charAt(0))) 
		...
		while ( i < str.length() && str.charAt(i) != '\0' )  
	      {
		   if(Character.isDigit(str.charAt(i))) ///////////////////////// FAULT CORRECTION: replaced i+1 to i
	         i++;
	       else
	         return false;
	      }                         /* end WHILE */
	...
	static boolean is_str_constant(String str)
	{
	  ...
	  if ( str.charAt(0) =='"')
	     ...
	     return false;	//////////////////////// FAULT CORRECTION: replaced true with false
	    }
	  else
	    return false;       /* other return FALSE */
	}
	  ...
	  if ( Character.isLetter(str.charAt(0)) ) 
	     {
		    ...
		    return true; /////////////////////// FALUT CORRECTION. replace false with true
	     }
	  else
		return false;  //////////////////////// FALUT CORRECTION. replace true with false
	}
	...
	{
		if      (str.equals("(")) //////////////////// FAULT CORRECTION. replaced ) with (
	    {
	...
	static boolean is_spec_symbol(char c)
	{
	    ...
	    if (c == '\'') /////////////////// FAULT CORRECTION. replaced / with \'
	    {
	        return true;
	    }
	    if (c == '`')
	...
	public static void main(String[] args)  {
		...
		if (args.length == 0) {	/* if not given filename,take as '""' */
			...
			return;
			//////////////////////// FAULT CORRECTION. added return;
		}
		PrinttokensFixed t = new PrinttokensFixed();
